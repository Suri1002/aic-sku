...
// $pincode =$_POST['pincode'];
                        ...
                        $sql = $conn->prepare("select email from students where email = ?");
                    ...
                    # insert data into database
                      $sql1 = $conn->prepare("INSERT INTO `students`(`username`, `email`, `password`, `firstName`, `lastName`) VALUES (?, ?, ?, ?, ?)");
                        $sql1->bind_param("sssss", $username, $email, $password, $fname, $lname);
                        $sql1->execute();
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12" align="center" style="padding-top: 3em;">
           ...
           <!--  <svg style="border-radius: 20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#e7008a" fill-opacity="1" d="M0,192L80,160C160,128,320,64,480,85.3C640,107,800,213,960,240C1120,267,1280,213,1360,186.7L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg> -->
            ...
            <form action="" method="post" class="pt-3">
                ...
                <div class="mb-4" align="center">
                    <input type="email" class="text-center" name="email" placeholder="Enter Email" required>
                </div>

                <div class="mb-4" align="center">
                    <input type="password" class="text-center" name="password" placeholder="Password" required>
                 ...
                 <div class="mb-4" align="center">
                    <input type="text" class="text-center" name="fname" placeholder="Enter First name" required>
                </div>
                 <div class="mb-4" align="center">
                    <input type="text" class="text-center" name="lname" placeholder="Enter Last name" required>
                </div>
           ...
           <!-- <h5 class="text-center text-danger pt-2"><?php echo "$mailerror";?></h5> -->
            ...
            <form action="" method="post" class="pt-3">
                <div class="mb-4" align="center">
                    ...
                    <input type="email" class="text-center" name="email" placeholder="Your Email" required>
                </div>
