            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col" class="sort" data-sort="name"><font color="green"> Student Id</font></th>
                    <th scope="col" class="sort" data-sort="budget"><font color="green">Student Name</font></th>
                    <th scope="col" class="sort" data-sort="status"><font color="green">Score</font></th>
                ...
                <tbody class="list">
                  <?php
                        ...
                        $sql = $conn->prepare("select * from scores");
                        ...
                        $sql1 = $conn->prepare("select * from students where id = $stdId");
                        // $sql->bind_param("s", $email);
                        $sql1->execute();
                        $result1 = $sql1->get_result();
                        $row1 = $result1->fetch_assoc();
                        $stdName = $row1['username'];
                        // $studentId = $row1['id'];
