...
<!-- Mirrored from demos.creative-tim.com/argon-dashboard/examples/icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 09:03:15 GMT -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Course Uploader</h6>
...
if (isset($_POST['submit'])) {
  ...
  if (isset($_FILES['image']['name'])) {
    ...
    if($upload == true)
    {
      echo "<script>Product addedd successfully</script>";
    }
  // }
  }
  else $image = "";

  $sql = mysqli_query($conn, "INSERT INTO `products`(`productImage`, `productName`, `productPrice`, `productDescription`) VALUES ('$image','$productName','$productPrice','$productDes')");
  if($sql) echo "<script>alert('Product uploaded');</script>";
        ...
        <div class=" col ">
          <div class="card">
            <div class="card-header bg-transparent">
              ...
              <h3 class="mb-0">Upload Course</h3>
            </div>
           <div>
